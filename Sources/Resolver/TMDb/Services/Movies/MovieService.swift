...
public protocol MovieProvider {
    ...
    func fetchDetails(forMovie id: TMDBMovie.ID, completion: @escaping (_ result: Result<TMDBMovie, TMDbError>) -> Void)
    ...
    func fetchCredits(forMovie movieID: TMDBMovie.ID,
    ...
    func fetchImages(forMovie movieID: TMDBMovie.ID,
    ...
    func fetchVideos(forMovie movieID: TMDBMovie.ID,
    ...
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    func recommendationsPublisher(forMovie movieID: TMDBMovie.ID, page: Int?) -> AnyPublisher<MoviePageableList, TMDbError>
...
public extension MovieProvider {
    ...
    func fetchReviews(forMovie movieID: TMDBMovie.ID, page: Int? = nil,
    ...
    func fetchRecommendations(forMovie movieID: TMDBMovie.ID, page: Int? = nil,
    ...
    func fetchSimilar(toMovie movieID: TMDBMovie.ID, page: Int? = nil,
                      completion: @escaping (Result<MoviePageableList, TMDbError>) -> Void) {
...
public extension MovieProvider {
    ...
    func reviewsPublisher(forMovie movieID: TMDBMovie.ID, page: Int? = nil) -> AnyPublisher<ReviewPageableList, TMDbError> {
    ...
    func similarPublisher(toMovie movieID: TMDBMovie.ID, page: Int? = nil) -> AnyPublisher<MoviePageableList, TMDbError> {
...
public extension MovieProvider {
    ...
    func reviews(forMovie movieID: TMDBMovie.ID, page: Int? = nil) async throws -> ReviewPageableList {
        try await reviews(forMovie: movieID, page: page)
    }

    func recommendations(forMovie movieID: TMDBMovie.ID, page: Int? = nil) async throws -> MoviePageableList {
        try await recommendations(forMovie: movieID, page: page)
    }

    func similar(toMovie movieID: TMDBMovie.ID, page: Int? = nil) async throws -> MoviePageableList {
