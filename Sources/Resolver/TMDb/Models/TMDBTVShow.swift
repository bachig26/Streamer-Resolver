...
/// A TV show.
public struct TMDBTVShow: Identifiable, Decodable, Equatable, Hashable, PosterURLProviding, BackdropURLProviding {
...
extension TMDBTVShow: Comparable {

    public static func < (lhs: TMDBTVShow, rhs: TMDBTVShow) -> Bool {
